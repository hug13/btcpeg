...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen p-3 md:p-6 lg:p-8">
      <div className="max-w-[600px] md:max-w-none mx-auto">
        
        {/* Header */}
        <header className="text-center py-6 md:py-8">
          <div className="mb-4">
            <h1 className="text-xl md:text-2xl lg:text-3xl font-mono terminal-glow mb-4">
              1 BTC = 1 BTC
            </h1>
            <div className="flex justify-center mb-4">
              <div className="text-matrix-bright font-mono text-xs md:text-sm">
                ₿ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ ₿
              </div>
            </div>
          </div>
        ...
        {/* Footer */}
        <footer className="text-center py-6 md:py-8 text-muted text-xs">
